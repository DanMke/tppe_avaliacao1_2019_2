...
public class Disciplina {
	...
	public Disciplina(String nome, String departamento, String codigo, int creditosTeoria, int creditosPratica,
		...
		verificaDados(nome, codigo, creditosTeoria, creditosPratica, creditosExtensao, creditosEstudos);
	...
	private void verificaDados(String nome, String codigo, int creditosTeoria, int creditosPratica,
			int creditosExtensao, int creditosEstudos) throws DadosDisciplinaIncompletosException {
		if (nome == null || codigo == null || creditosTeoria < 0 || creditosPratica < 0 || creditosExtensao < 0 || creditosEstudos < 0 ||
			...
			StringBuilder builder = criaMensagemErro(nome, codigo, creditosTeoria, creditosPratica, creditosExtensao,
					creditosEstudos);
			throw new DadosDisciplinaIncompletosException(builder.toString());
		}
	}

	private StringBuilder criaMensagemErro(String nome, String codigo, int creditosTeoria, int creditosPratica,
