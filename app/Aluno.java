...
public class Aluno {
	...
	public Aluno(String nome, String prefixoMatricula, String sufixoMatricula, String email, String celular) throws DadosAlunoIncompletoException {
		verificaDados(nome, prefixoMatricula, sufixoMatricula);
	...
	private void verificaDados(String nome, String prefixoMatricula, String sufixoMatricula)
		...
		if (nome == null || prefixoMatricula == null || sufixoMatricula == null ||
			...
			StringBuilder builder = criaMensagemErro(nome, prefixoMatricula, sufixoMatricula);
			throw new DadosAlunoIncompletoException(builder.toString());
		}
	}

	private StringBuilder criaMensagemErro(String nome, String prefixoMatricula, String sufixoMatricula) {
